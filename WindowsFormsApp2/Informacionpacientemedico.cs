...
namespace WindowsFormsApp2
{
    public partial class Informacionpacientemedico : Form
    {
        ...
        private void bttguardar_Click(object sender, EventArgs e)
        {
            ...
            string Tratamientoarealizar = cbxTratamiento.SelectedItem as string;
        ...
        private bool ValidarDatos()
        {
            ...
            if (cbxregimen.SelectedItem == null)
            {
                errorMensaje.SetError(cbxTratamiento, "Por favor ingrese el tratamiento");
                return false;
            }
            else
            {
                errorMensaje.SetError(cbxTratamiento, null);
            }
        ...
        private void Informacionpacientemedico_Load(object sender, EventArgs e)
        {
